...
\newcommand{\eunpack}[5]{
  #1{unpack}#2{\langle}#3 #1{,} #4 #2{\rangle\! = \,} #3 \,#1{in}\, #4
}
\newcommand{\elet}[5]{#1{let}\ #3\:#2{=}\:{#4}\ #1{in}\ #5}
\newcommand{\efold}[3]{#1{fold}_{#2} \, #3}
\newcommand{\eunfold}[2]{#1{unfold} \, #1}
...
\newcommand{\ctxttysh}{#2 #1{\ctxarrow} \, #3}
