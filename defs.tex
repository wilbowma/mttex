...
\makeatletter
\newcommand{\newlmetavarStar}[5]{
  \expandafter\newcommand\csname #3#4metavar\endcsname[3]{
    \lmetavar{#1{#5}}{#2{##1}}{#2{##2}}{#2{\prime}}{##3}
  }
  \expandafter\newcommand\csname #3#4\endcsname{
    \csname #3#4metavar\endcsname{}{}{0}
  }
  \expandafter\newcommand\csname #3#4in\endcsname[1]{
    \csname #3#4metavar\endcsname{##1}{}{0}
  }
  \expandafter\newcommand\csname #3#4to\endcsname[2][0]{
    \csname #3#4metavar\endcsname{}{##2}{##1}
  }
  \expandafter\newcommand\csname #3#4pr\endcsname[1][1]{
    \csname #3#4metavar\endcsname{}{}{##1}
  }
  \expandafter\newcommand\csname #3#4one\endcsname{
    \csname#3#4metavar\endcsname{1}{}{0}
  }
  \expandafter\newcommand\csname #3#4onepr\endcsname[1][1]{
    \csname#3#4metavar\endcsname{1}{}{##1}
  }
  \expandafter\newcommand\csname #3#4two\endcsname{
    \csname#3#4metavar\endcsname{2}{}{0}
  }
  \expandafter\newcommand\csname #3#4twopr\endcsname[1][1]{
    \csname#3#4metavar\endcsname{2}{}{##1}
  }
  \expandafter\newcommand\csname #3#4n\endcsname{
    \csname#3#4metavar\endcsname{n}{}{0}
  }
  \expandafter\newcommand\csname #3#4npr\endcsname[1][1]{
    \csname#3#4metavar\endcsname{n}{}{##1}
  }
  \expandafter\newcommand\csname #3#4i\endcsname{
    \csname#3#4metavar\endcsname{i}{}{0}
  }
  \expandafter\newcommand\csname #3#4ipr\endcsname[1][1]{
...
\newcommand{\polyfuntyS}[5]{\polyfunty{#1}{#2}{#3}{#4}}
...
\newcommand{\newltypes}[4]{
  {
    \let\def\gdef
    \foreach \t in {#4}{
      \expandafter\newcommand\csname #3\t ty\endcsname{
        \csname\t tyS\endcsname{#1}{#2}
      }
    }
  }
}
...
\newcommand{\epair}[3]{#1{\langle}#2#1{,}#3{#1{\rangle}}}
